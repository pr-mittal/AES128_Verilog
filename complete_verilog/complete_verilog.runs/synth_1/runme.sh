...
HD_PWD='C:/Users/prana/OneDrive/Documents/GitHub/AES128_Verilog/complete_verilog/complete_verilog.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decrypt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decrypt.tcl
